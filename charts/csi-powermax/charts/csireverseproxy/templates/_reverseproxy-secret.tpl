{{/*
Template for creating the reverse proxy secret contents.
Using this template allows us to easily include the data and base64 encode
it in one command from the secret.yaml file.
*/}}
{{- define "reverseproxy.secret" -}}
